...
const DISABLE_DEFAULT_SEED_ONCE_KEY = "@doya:e2e-disable-default-seed-once";
const SEED_NONCE_KEY = "@doya:e2e-seed-nonce";
const REGISTRY_KEY = "@doya:daemon-registry";
const E2E_KEY = "@doya:e2e";
  ...
  private async prepare(): Promise<void> {
    ...
    await this.page.evaluate(
      ({ keys, registry: storedRegistry, createAgentPreferences: storedPreferences }) => {
        ...
        localStorage.setItem("@doya:create-agent-preferences", JSON.stringify(storedPreferences));
