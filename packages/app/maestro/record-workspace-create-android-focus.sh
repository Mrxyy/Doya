...
OUT_DIR="/tmp/doya-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/doya-maestro-videos"
DEVICE_VIDEO="/sdcard/doya-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/doya-maestro-workspace-create-focused.mp4"
