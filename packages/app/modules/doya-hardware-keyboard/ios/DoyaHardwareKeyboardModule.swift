...
private weak var activeModule: DoyaHardwareKeyboardModule?
private var isHardwareSubmitEnabled = false

@objc
public class DoyaHardwareKeyboardReactDelegateHandler: ExpoReactDelegateHandler {
  public override func createRootViewController() -> UIViewController? {
    return DoyaHardwareKeyboardRootViewController()
  }
}

public class DoyaHardwareKeyboardModule: Module {
  public func definition() -> ModuleDefinition {
    Name("DoyaHardwareKeyboard")
...
private final class DoyaHardwareKeyboardRootViewController: UIViewController {
  ...
  private func canSubmitCurrentTextInput() -> Bool {
    guard let responder = UIResponder.doyaCurrentFirstResponder else {
      return false
    }
...
private extension UIResponder {
  ...
  static var doyaCurrentFirstResponder: UIResponder? {
