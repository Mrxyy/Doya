    ...
    <Modal transparent animationType="fade" statusBarTranslucent visible onRequestClose={onClose}>
      <View style={styles.root}>
        <Pressable
          ...
          accessibilityLabel={translateNow("ui.dismiss.image.1qygsv9")}
          onPress={onClose}
        ...
        <View style={styles.contentLayer}>
          <View style={styles.imageArea}>
            {hasError ? (
              <Text style={styles.errorText}>
                {translateNow("ui.couldn.apostrophe.t.load.image.lgta3g")}
              </Text>
            ) : (
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel={translateNow("ui.close.image.64kftf")}
            hitSlop={8}
            onPress={onClose}
