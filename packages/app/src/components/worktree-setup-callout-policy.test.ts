...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when doya config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading doya config fails or has not completed", () => {
