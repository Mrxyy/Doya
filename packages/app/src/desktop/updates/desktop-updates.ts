...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/getdoya/doya/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Doya-${normalizedVersion}-arm64.dmg`;
}
