import type { AgentProvider, ToolCallDetail } from "@getdoya/protocol/agent-types";
import type { AgentAttachment, AgentStreamEventPayload } from "@getdoya/protocol/messages";
  ...
  if (input.optimistic) {
    return {
      ...
      ...(input.optimistic.selectionPreviewUri
        ...
        : {}),
      ...(input.optimistic.selectionImage
        ? { selectionImage: input.optimistic.selectionImage }
        : {}),
    };
  }
