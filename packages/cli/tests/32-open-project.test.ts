...
const existingProject = join(await mkdtemp(join(tmpdir(), "doya-open-project-")), "project");
...
const previousDesktopCli = process.env.DOYA_DESKTOP_CLI;
process.env.DOYA_DESKTOP_CLI = "1";
...
process.env.DOYA_DESKTOP_CLI = previousDesktopCli;
