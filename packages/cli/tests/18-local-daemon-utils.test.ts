...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/doya.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/doya.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\doya-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\doya-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.doya\\doya.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\doya.sock"), null);
