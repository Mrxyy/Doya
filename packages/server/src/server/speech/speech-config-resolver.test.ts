...
describe("resolveSpeechConfig", () => {
  ...
  test("resolves feature-scoped local speech settings", () => {
    ...
    const env = {
      DOYA_DICTATION_LOCAL_STT_MODEL: "parakeet-tdt-0.6b-v2-int8",
      DOYA_VOICE_LOCAL_STT_MODEL: "parakeet-tdt-0.6b-v2-int8",
      DOYA_VOICE_LOCAL_TTS_MODEL: "kokoro-en-v0_19",
      DOYA_VOICE_LOCAL_TTS_SPEAKER_ID: "5",
      DOYA_VOICE_LOCAL_TTS_SPEED: "1.35",
      DOYA_DICTATION_LANGUAGE: "es",
      DOYA_VOICE_LANGUAGE: "pt",
      DOYA_LOCAL_MODELS_DIR: "/tmp/models",
      OPENAI_API_KEY: "env-key",
      DOYA_VOICE_STT_PROVIDER: "openai",
      DOYA_DICTATION_STT_PROVIDER: "local",
      DOYA_VOICE_TTS_PROVIDER: "local",
