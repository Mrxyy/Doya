...
import type { DoyaOpenAIConfig, DoyaSpeechConfig } from "../bootstrap.js";
...
function resolveRequestedSpeechProviders(
  speechConfig: DoyaSpeechConfig | null,
...
export interface SpeechService {
  ...
  resolveSttLanguage: () => string | undefined;
  ...
  resolveDictationSttLanguage: () => string | undefined;
...
export function createSpeechService(params: {
  logger: Logger;
  openaiConfig?: DoyaOpenAIConfig;
  speechConfig?: DoyaSpeechConfig;
}): SpeechService {
  ...
  return {
    ...
    resolveSttLanguage: () => speechConfig?.sttLanguages?.voice,
    resolveTts: () => ttsService,
    resolveDictationStt: () => dictationSttService,
    resolveDictationSttLanguage: () => speechConfig?.sttLanguages?.dictation,
