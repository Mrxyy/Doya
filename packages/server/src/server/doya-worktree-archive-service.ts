...
import {
  deleteDoyaWorktree,
  resolveDoyaWorktreeRootForCwd,
  WorktreeTeardownError,
} from "../utils/worktree.js";
import type { TerminalManager } from "../terminal/terminal-manager.js";

export interface ArchiveDoyaWorktreeDependencies {
  doyaHome?: string;
...
export async function archiveDoyaWorktree(
  dependencies: ArchiveDoyaWorktreeDependencies,
  options: {
    targetPath: string;
  ...
  const resolvedWorktree = await resolveDoyaWorktreeRootForCwd(targetPath, {
