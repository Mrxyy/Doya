...
export type DoyaNodeEnv = "development" | "production" | "test";
...
export function createDoyaInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveDoyaNodeEnv(env: NodeJS.ProcessEnv): DoyaNodeEnv | undefined {
  const value = env[DOYA_NODE_ENV];
