    ...
    it("uses the packaged runner when the desktop app is packaged", () => {
      expect(
        createNodeEntrypointInvocation({
          ...
          isPackaged: true,
          packagedRunnerPath:
            "/Applications/Doya.app/Contents/Resources/app.asar/dist/daemon/node-entrypoint-runner.js",
        ...
        command: "/Applications/Doya.app/Contents/MacOS/Doya",
        args: [
