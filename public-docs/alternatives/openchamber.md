...
description: Doya ships native iOS and Android apps, runs on macOS, Linux, and Windows, and supports 30+ agents. OpenChamber is macOS only with a PWA and is built around OpenCode.
nav: OpenChamber
order: 103
---
...
OpenChamber runs on macOS, around OpenCode, with a phone PWA. Doya runs OpenCode too, on macOS, and adds:
...
Doya ships a native iOS and Android app with the same feature set as the desktop. Install from the App Store or Google Play.
...
Doya's speech-to-text and text-to-speech run locally on your device. OpenChamber does not have voice.
...
See also: [Doya vs Conductor](/docs/alternatives/conductor), [Doya vs Superset](/docs/alternatives/superset), [Doya vs Happy Coder](/docs/alternatives/happy-coder).
